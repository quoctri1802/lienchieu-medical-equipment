...
function App() {
  ...
  return (
    <div className="app-container">
      ...
      <div className={`sidebar-container ${isSidebarOpen ? 'open' : ''}`}><Sidebar activeView={activeView} setActiveView={(v) => { setActiveView(v); setIsSidebarOpen(false); }} user={user} onLogout={handleLogout} /></div>
